  ...
  const highlights = [
    {
      text: (
        <>
          <span className="text-white font-bold">Codesip Technology</span> is a leading <span className="text-secondary font-bold drop-shadow-[0_0_12px_rgba(0,255,136,0.3)] tracking-wide">GenAI solutions</span> provider, empowering modern businesses with cutting-edge intelligence.
        </>
      ),
